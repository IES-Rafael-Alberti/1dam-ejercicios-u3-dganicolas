...
#def diego_quiere_funciones_si_no_pelea(directorio):
#    directorio = directorio.split("\n")
#    print(directorio)
#    return directorio
#
#def crear_diccionario(directorio:list):
#    d={}
#    claves= directorio[0]
#    claves=list(claves.split(";"))
...
#    directorio=diego_quiere_funciones_si_no_pelea(directorio)
#    d={}
#    d=crear_diccionario(directorio)
#
#
#
...
def main():
    ...
    for linea in lineas[1:]:
        ...
        if linea:
            ...
            directorio_clientes[cliente_info[nombres_campos[0]]]=funciona
